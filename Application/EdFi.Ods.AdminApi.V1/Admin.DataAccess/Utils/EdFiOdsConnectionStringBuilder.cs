...
namespace EdFi.Ods.AdminApi.V1.Admin.DataAccess.Utils
{
    public class EdFiOdsConnectionStringBuilder
    {
        ...
        {
            var connectionStringSettings = System.Configuration.ConfigurationManager.ConnectionStrings["EdFi_Ods"];
